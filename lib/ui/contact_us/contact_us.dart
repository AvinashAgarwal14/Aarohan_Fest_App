...
List<Map> contacts = [
  contactCard_ATH,
  contactCard_Logistics,
  contactCard_techteam,
  contactCard_treasury
];

Map contactCard_Logistics = {
  "Domain": "Logistics",
  "User": [
    "Devansh Goenka",
    "Saurabh Kumar Gupta",
                              ...
                              children: <Widget>[
                                Flexible(
                                  child: IconButton(
                                    ...
                                    iconSize: 15.0,
                                    icon: Icon(facebook, color: Colors.grey),
                                    disabledColor: Colors.black,
                                    color: Colors.blueAccent,
                                    onPressed: () {
                                      _launchURL(contactCard["ProfilesFacebook"]
                                          [index]);
                                    },
                                  ),
                                ),
                                IconButton(
                                  //padding: EdgeInsets.all(0.0),
                                  iconSize: 15.0,
                                  icon: Icon(linkedin, color: Colors.grey),
                                  onPressed: () {
                                    _launchURL(

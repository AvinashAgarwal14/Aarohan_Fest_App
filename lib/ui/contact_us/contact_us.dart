                                ...
                                children: <Widget>[
                                  Container(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image.asset(contactCard["IOC"][index],
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children:<Widget>[
                                        Text(
                                      contactCard["OverallCoordinator"][index],
                                ...
                                children: <Widget>[
                                  Container(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image.asset(contactCard["IGS"][index],
                                              height: double.infinity,
                                              width: double.infinity,
                                              fit: BoxFit.cover))),
                                  Padding(
                                    ...
                                    child: Column(
                                      children:<Widget>[
                                        Text(
                                      contactCard["GeneralSecretary"][index],
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500),
                                ...
                                children: <Widget>[
                                  Container(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image.asset(contactCard["IT"][index],
                                              height: double.infinity,
                                              width: double.infinity,
                                              fit: BoxFit.cover))),
                                  Padding(
                                ...
                                children: <Widget>[
                                  Container(
                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: Image.asset(contactCard["ICC"][index],
                                              height: double.infinity,
                                              width: double.infinity,
                                              fit: BoxFit.cover))),
                                  Padding(
                                    ...
                                    child: Column(
                                      children:<Widget>[
                                        Text(
                                      contactCard["CorporateCommunication"][index],
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500),
